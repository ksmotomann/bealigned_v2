  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.content}>
        ...
        <Text style={styles.sectionTitle}>2. Informational Purpose Only</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>3. No Emergency or Crisis Services or Legal Advice</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.subSectionTitle}>Use at Your Own Risk</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>6. Jurisdictional Limitations</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>7. Third-Party Links & Third-Party Information</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>8. Artificial Intelligence</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.subSectionTitle}>AI Functionality</Text>
        <Text style={styles.paragraph}>
          The AI tool provides prompts and content automatically, based on algorithms and the data you enter or select. Outputs are intended to support creativity, productivity, or engagement, but are not guaranteed to be accurate, complete, or suited to any specific need.
        </Text>

        <Text style={styles.subSectionTitle}>User Responsibilities and Conduct</Text>
        <Text style={styles.paragraph}>
          You are solely responsible for any use of the AI tool and for any content you generate, submit, or act upon. You must not use the AI tool for unlawful, harmful, or prohibited purposes, including but not limited to:
        </Text>
        <Text style={styles.bulletPoint}>
          • Generating content that is illegal, offensive, discriminatory, or infringes on intellectual property rights
        </Text>
        <Text style={styles.bulletPoint}>
          • Using the AI tool in connection with medical, legal, financial or other regulated advice, except as expressly permitted
        </Text>
        <Text style={styles.bulletPoint}>
        ...
        <Text style={styles.subSectionTitle}>Data Handling and Privacy</Text>
        <Text style={styles.paragraph}>
          All inputs and outputs from the AI tool may be logged and used for the purposes of providing the service, improving our models, and for analytics as described in our Privacy Policy. We do not permit third parties to use your data for training their own models without your explicit consent.
        </Text>

        <Text style={styles.subSectionTitle}>Limitations of Service</Text>
        <Text style={styles.paragraph}>
          AI-generated prompts are produced using probabilistic methods and may not always be available, accurate, or free from errors. The AI tool is provided "as is" and without warranties of any kind, except as required by law.
        </Text>

        <Text style={styles.subSectionTitle}>Disclaimers and Indemnity</Text>
        <Text style={styles.paragraph}>
          We disclaim all warranties regarding the AI content's fitness for any purpose. By using the AI tool, you waive any claim against us related to the accuracy or reliability of AI-generated prompts. You agree to indemnify us for any claims arising from misuse of the AI service, including violations of these Terms or applicable law.
        </Text>

        <Text style={styles.subSectionTitle}>Updates and Changes</Text>
        <Text style={styles.paragraph}>
          We reserve the right to modify or discontinue the AI tool at any time without notice. Continued use of the tool after such modifications constitutes acceptance of the updated Terms.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>9. Management of the Site</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          Any unauthorized use of the Content constitutes a violation of the Site's rights and may subject you to civil and/or criminal liability under applicable laws. The Site reserves all rights not expressly granted herein and will pursue all remedies available in law or equity to protect such rights.
        </Text>
        ...
        <Text style={styles.sectionTitle}>14. Limitation on Liability</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>16. Payment Processing</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          Your privacy is important to us. Please review our Privacy Policy for information on how we collect, use, and safeguard your personal data.
        </Text>

        <Text style={styles.sectionTitle}>Contact Us</Text>
        <Text style={styles.paragraph}>
          If you have any questions about these Terms, please contact us at support@bealigned.co.
        </Text>
